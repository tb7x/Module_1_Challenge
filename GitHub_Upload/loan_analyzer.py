...
average_loan_price = sum_of_loans / total_loans
...
def calculate_present_value(future_value, remaining_value, annual_discount_rate):
...
for entry in loans:
    entry = {"loan_price" : [500], "loan_price" : [200]}
...
print("Writing the date to a csv file.")
